...
router.post("/create-checkout-session", async (req, res) => {
  ...
  const session = await stripe.checkout.sessions.create({
    ...
    success_url: "https://stripe-payment-production-07af.up.railway.app/stripe/checkout-success",
    cancel_url:  "https://stripe-payment-production-07af.up.railway.app/stripe/cancel",
  });
